...
from Q1_DataLoader import recovery_train

# Length of the input sequence during training
timesteps = 25
data_coeff = 1
output = 4
model_name = f'Recovery_{output}.h5'
print(model_name)
...
def get_data(data_sets, data_coeff):
    ...
    inputs, outputs = recovery_train_data(data[0], timesteps, data_coeff, output)
    print(data[0], "Loaded", end='\r')
    for dataSet in data[1:]:
        inputData, outputData = recovery_train_data(dataSet, timesteps, data_coeff, output)
