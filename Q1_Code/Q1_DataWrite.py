...
for i in range(500):
    ...
    BARO_10Hz = downsample(BARO, 40)
    ATT_10Hz = downsample(ATT, 40)
    IMU_10Hz = downsample(IMU, 40)
    RCOU_10Hz = downsample(RCOU, 40)
    csv_data = np.array(np.hstack((IMU_10Hz, BARO_10Hz, ATT_10Hz, RCOU_10Hz)))
