...
model.fit(inputs, outputs, epochs=4, batch_size=5000,callbacks=[checkpoint, early_stopping, reduce_lr])
model.fit(inputs, outputs, epochs=8, batch_size=15000,callbacks=[checkpoint, early_stopping, reduce_lr])
model.fit(inputs, outputs, epochs=12, batch_size=25000,callbacks=[checkpoint, early_stopping, reduce_lr])